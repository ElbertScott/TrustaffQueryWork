...
(
	...
	WHERE 1=1 
	AND (FP.SubmitStatus IN (411,414,423,426,567,568,576,579,601,602,619,623,638,639))
	AND FP.trustaffCompany_ID != 9
	AND fp.RequestDate > GETDATE() - 365 
) as x
where 1=1
and Recruiter = SUBSTRING('KGARRETS',0,9) --Add Recruiter parameter here
order by Facility


--Kellie Garretson - Recruiter
--KGARRETS - MWwkwQKll
--Michele Vore - 17623534


select *
from dbo.UserList
order by GM_Username

select *
from dbo.FacPackets
where FacPacketID in 
(
	'602465',
	'606637',
	'605561',
