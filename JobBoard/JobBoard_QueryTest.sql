...
(
	...
	(
		...
		FROM dbo.FacPackets  fp WITH (NOLOCK)
		WHERE 1=1
	...
	and jr.fk_StatusID NOT IN (1,6,9)--= 1--in (1,6,9)
	AND C2.UVMSMSP not like '%healthtrust%'
	AND C2.UGRADE IN (1,2,3,4)
	and DivisionName = 'Travel'
	--AND ProfessionName = 'Nursing'
